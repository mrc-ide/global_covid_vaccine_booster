...
df <- df %>%
  group_by(income_group, target_pop, max_coverage, age_groups_covered, age_groups_covered_label, vaccine_doses, vacc_start, rollout_rate, vacc_per_week, max_Rt, max_Rt_omicron, t_d3, dose_3_timing, vfr) %>%
...
df_summarise <- df %>%
  ...
  group_by(timestep, income_group, target_pop, max_coverage, age_groups_covered,age_groups_covered_label, vaccine_doses, vacc_start, max_Rt, vfr, max_Rt_omicron, rollout_rate, t_d3, vacc_per_week, deaths_med, deaths_lower, deaths_upper, inc_med, inc_lower, inc_upper, prop_R_med, total_doses_med) %>%
